namespace CI.Debt.Forms
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.initBooksWorker = new System.ComponentModel.BackgroundWorker();
			this.rowsDataGrid = new System.Windows.Forms.DataGridView();
			...
			this.debtDocProperties.Month = 12;
			...
			this.debtDocProperties.Year = 2008;
			this.debtDocProperties.DebtPropertiesChanged += new CI.Debt.Forms.DebtPropertiesChangedEventHandler(this.debtDocProperties_DebtPropertiesChanged);
			// 
			// initBooksWorker
			// 
			this.initBooksWorker.WorkerReportsProgress = true;
			this.initBooksWorker.DoWork += new System.ComponentModel.DoWorkEventHandler(this.initBooksWorker_DoWork);
			this.initBooksWorker.RunWorkerCompleted += new System.ComponentModel.RunWorkerCompletedEventHandler(this.initBooksWorker_RunWorkerCompleted);
			this.initBooksWorker.ProgressChanged += new System.ComponentModel.ProgressChangedEventHandler(this.initBooksWorker_ProgressChanged);
			// 
			// rowsDataGrid
			// 
			...
			// ClassifierColumn
			// 
			dataGridViewCellStyle4.Font = new System.Drawing.Font("Courier New", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
			this.ClassifierColumn.DefaultCellStyle = dataGridViewCellStyle4;
			...
			this.Amount2Column.DefaultCellStyle = dataGridViewCellStyle6;
		...
		private System.Windows.Forms.DataGridView rowsDataGrid;
		...
		private System.ComponentModel.BackgroundWorker initBooksWorker;
