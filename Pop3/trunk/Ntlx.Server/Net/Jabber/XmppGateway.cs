...
namespace ASC.Xmpp.Server.Gateway
{
	class XmppGateway : IXmppReceiver
	{
		...
		private IDictionary<string, IXmppListener> listeners = new Dictionary<string, IXmppListener>();

		private IDictionary<string, string> connectionListenerMap = new Dictionary<string, string>();
