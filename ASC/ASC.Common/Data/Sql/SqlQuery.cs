...
namespace ASC.Common.Data.Sql
{
    public class SqlQuery : ISqlInstruction
    {
        ...
        private readonly List<SqlQuery> unions = new List<SqlQuery>();
        ...
        public string ToString(ISqlDialect dialect)
        {
            ...
            unions.ForEach(u => sql.AppendFormat(" union {0}", u.ToString(dialect)));
            return sql.ToString();
        }
        ...
        public object[] GetParameters()
        {
            ...
            unions.ForEach(u => parameters.AddRange(u.GetParameters()));
