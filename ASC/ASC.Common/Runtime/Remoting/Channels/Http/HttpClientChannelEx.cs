...
{
    public class HttpClientChannelEx : HttpClientChannel, IChannelWithServices
    {
        public HttpClientChannelEx(IDictionary properties, IClientChannelSinkProvider provider)
